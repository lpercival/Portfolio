...
*  be used to create a new authorized user. Form submittal is done with a call to a
						...
						<fieldset>
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<button type="button" name="create" onclick="newUser()" class="btn btn-default"> Create </button>
								</div>
							</div>
						</fieldset>
					</form>

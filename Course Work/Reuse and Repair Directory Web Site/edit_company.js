...
*  Description: JavaScript file for editing a company. Makes a request to PHP
*  to validate the input and update the companies table, and also update the

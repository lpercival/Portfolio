...
*  Date Created: 5/2/15
*  Description: JavaScript file for creating a new category. Makes a request to PHP
*  to validate the input and add it to the categories table.
*/
